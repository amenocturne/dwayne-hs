...
**Types:** Use lens-generated accessors (e.g., `_field` with `makeLenses ''TypeName`). Prefer type classes for polymorphism (`RenderTask`, `Writer`, `Searcher`, `Refileable`, `Injection`).
